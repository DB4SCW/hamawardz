                    ...
                    <form action="/event/{{ $event->slug }}/createaward" method="post" style="margin-bottom: 60px;">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="specific_callsign_computation">
                                <option value="-1" {{ -1 == old('specific_callsign_computation') ? 'selected' : '' }}>no restriction</option>
                                <option value="0" {{ 0 == old('specific_callsign_computation') ? 'selected' : '' }}>exclude following callsigns</option>
                                <option value="1" {{ 1 == old('specific_callsign_computation') ? 'selected' : '' }}>include following callsigns</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="specific_callsigns">Exclude/Include these callsigns from award computation (not for DXCC or continent rules):</label>
                            <input name="specific_callsigns" class="form-control" type="text" value="{{ old('specific_callsigns')}}">
                        </div>
